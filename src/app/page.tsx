...
export default function Home() {
  ...
  return (
    <div>
      ...
      >
        {/* <div className="  bg-orange-200 w-screen flex z-0 relative container justify-center rounded-b-xl pt-24 pb-24"> */}
        {/* <div className="  bg-deep-orange-300 w-screen flex z-0 relative container justify-center rounded-b-xl pt-24 pb-24"> */}
        <div className={" bg-".concat(colour).concat("-").concat(intensity).concat(" w-screen flex relative container justify-center rounded-b-xl pt-24 pb-24")}>
          {/* <div className="  bg-brown-500 w-screen flex relative container justify-center rounded-b-xl pt-24 pb-24"> */}
          {/* <Typography className="font-mono text-4xl relative bottom-12 text-gray-800" >BUSKINGKHAI</Typography> */}
          <Typography className="font-mono text-4xl relative bottom-12 text-brown-200" >BUSKINGKHAI</Typography>
        </div>
        <div className="colour-selector relative bottom-24 w-40">
