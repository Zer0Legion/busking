...
export default function Requests() {
    return (
        <div>
            <Navbar></Navbar>
            <div
                className="container flex flex-col items-center gap-2 p-2 h-screen justify-center"
            >
                <Typography className="flex justify-center text-2xl mb-4 font-mono ">My Links</Typography>
