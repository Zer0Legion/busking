...
export default function HomeWriteup() {
    return <div
        className="my-2 p-4 container flex flex-col justify-center max-w-screen items-center"
    >
        ...
        <Typography className="font-semibold font-mono m-2">About Me</Typography>
        <Typography>
        ...
        <Typography>
            I love pop and oldies, so feel free to <a href="./requests" className="underline text-blue-gray-100">request some of your favourites!</a>
        </Typography>
    </div>
}